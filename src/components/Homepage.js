...
import fire from '../Forestfire.jpg';
import reef from '../NewReefDead.jpg';
import iceburg from '../iceburgnew.jpg';
import animal from '../Pika.jpg';
 function Homepage() {
      return (
        <body>
      ...
      <div className="row">
        ...
        <span className="homeimgtext">
          In the past 18 years wildfires have begun to 
 burn double  the amount of land due to global warming.
          </span>
        </div>
        <div className="column">
        ...
        <span className="homeimgtext">
          The polar ice caps are melting at rates six times 
          faster than in the 1990s due to global warming. 
          </span>
        </div>
        <div className="column">
